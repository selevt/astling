...
<Dialog bind:open={open} onClose={handleClose} title="Rename Branch">
  <form onsubmit={(e) => { e.preventDefault(); handleSubmit(); }}>
    ...
    <div class="dialog-actions">
      <button type="button" class="dialog-btn dialog-btn-cancel" onclick={handleClose}>Cancel</button>
      <button type="submit" disabled={isSubmitting || !isValid} class="dialog-btn dialog-btn-primary">
